            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="public/uploads/product/{{$product->product_image}}" height="100px" width="100px"></td>
                        ...
                        <td class="control">
                            ...
                            <a onclick="return confirm('Bạn có muốn xóa?')" href="{{URL::to('/delete-product/'.$product->product_id)}}" class="active styling-edit confirmation" ui-toggle-class="">
