                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="control">
                            ...
                            <a onclick="return confirm('Bạn có muốn xóa?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit confirmation" ui-toggle-class="">
