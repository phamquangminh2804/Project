...
<body>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/danh-muc-san-pham/'.$category->slug_category_name)}}">{{$category->category_name}}</a></h4>
								</div>
							</div>
							@endforeach
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->slug_brand_name)}}"> {{$brand->brand_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div>
	...
	<!-- thich va chia se-->
	<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v20.0" nonce="4LWvqfvW"></script>
	<!-- binh luan-->
	{{-- <div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v20.0" nonce="nJhtjlNj"></script> --}}
</body>
</html>